...
export default function Page() {
  const examplePath = [
    ...
    { label: "Групповые", isCurrent: true },
  ];
  ...
  return (
    <main className=" container px-[25px]   xl:px-0 mx-auto">
      ...
      <div className=" mt-[30px] pb-[10px] scroll-changed overflow-x-scroll flex items-center gap-x-[10px] just">
        <div className="border w-[210px] cursor-pointer  flex items-center font-bold px-[28px] justify-center border-blue-text text-blue-text l-100 rounded-3xl text-center l-140  text-[16px]  h-[60px] ">
          Все экскурсии
        </div>
        ...
        <Link href={`/group`}>
          <div className="border  w-[210px] cursor-pointer bg-blue flex items-center font-bold px-[28px] justify-center  text-white l-100 rounded-3xl text-center l-140  text-[16px]  h-[60px] ">
            Групповые
          </div>
        </Link>
      </div>
